...
const mainData = function () {
    let articles = [{a:'家用电器'},{a:'羽绒服/数码'},{a:'家居/家具'},{a:'素食/卤食'},{a:'坚果/炒货'},{a:'糖果/蜜栈'},{a:'巧克力'},{a:'海鲜肉类'},{a:'箱包'}]
...
const sortsData = function () {
    let articles = [{a:'白色'},{a:'红色'},{a:'黑色'},{a:'灰色'}]
...
const detailData = function () {
  let articles = {first:'品牌：波司登数码、通讯'
  ,second:'羽绒服',third:'波司登羽绒服',fourth:'羽绒服'
  ,name:'...',pro_num:1,place: '杭州运输中心',
  price:'1399',pingjia:'22222',url:'D:\Web前端技术高级\project_092218210_刘世顺\src\assets\phone2.jpg'}
